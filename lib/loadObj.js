...
function loadObj(objPath, options) {
  ...
  function createVertex(p, u, n, ignoreBadNormals = false) {
    // Positions
...
>>>>>>> undo
  ...
  function addVertex(v, p, u, n, ignoreBadNormals = false) {
    let index = vertexCache[v];
    if (!defined(index)) {
      index = vertexCount++;
      vertexCache[v] = index;
      createVertex(p, u, n, ignoreBadNormals);
