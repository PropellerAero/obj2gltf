 ...
 * @param {Boolean} [options.ignoreBadNormals=false] The glTF will be saved with the KHR_materials_unlit extension.
...
function obj2gltf(objPath, options) {
  ...
  options.ignoreBadNormals = defaultValue(
    options.ignoreBadNormals,
    defaults.ignoreBadNormals
  );
